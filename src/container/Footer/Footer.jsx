    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:ernestniiyoyowah@gmail.com" className="p-text">
            ernestniiyoyowah@gmail.com
          </a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+233 50-692-3484" className="p-text">
            +233 50-692-3484
          </a>
        </div>
        <div className="app__footer-card">
      ...
      <div className="app__footer-card-med">
        ...
        <div>
          <a href="https://www.linkedin.com/in/ernest-yoyowah-4bb514240">
            <FaLinkedin />
          </a>
        </div>
      </div>
